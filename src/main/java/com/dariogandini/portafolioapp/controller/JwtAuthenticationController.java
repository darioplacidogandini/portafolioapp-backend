...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticanRequest) throws Exception {
        authenticate(authenticanRequest.getUsername(), authenticanRequest.getPassword());   

        final UserDetails userDetails = userDetailsService.
        loadUserByUsername(authenticanRequest.getUsername());
